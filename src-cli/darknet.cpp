...
/// Empicically calculate the speed of processing the specified network
/// with a matched-sized dummy input image.
void speed(char *cfgfile, int count)
{
	...
	double durationSeconds = durationMicroSeconds / 1000000;
	printf("\n%d evals, %f seconds\n", count, durationSeconds);
	printf("Speed: %f sec/eval\n", durationSeconds / count);
	printf("Speed: %f Hz\n", count / durationSeconds);
}

/// Calculate how many FLOPS are necessary to process the provided network
/// @todo This outoupt does not always line up with what is generated by loading the network
